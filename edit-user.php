...
if (isset($_GET['id'])) {
    ...
    $userInfo = mysqli_fetch_assoc($selectUser);
}
...
if (isset($_POST['submit'])) {
    ...
    $updateData = mysqli_query($con, "UPDATE `user` SET `name`='$name',`number`='$number',`email`='$email' WHERE id = $userId");
        ...
        <div class="row justify-content-center">
            ...
            <form class="col-md-6" method="POST" action="#">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="number" value="<?php echo $userInfo['number'] ?>" class="form-control"
                        id="exampleFormControlInput1" placeholder="Contact Number">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Email</label>
                    <input type="email" name="email" value="<?php echo $userInfo['email'] ?>" class="form-control"
